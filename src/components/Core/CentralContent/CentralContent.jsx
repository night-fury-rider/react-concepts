...
const CentralContent = props => {
  ...
  return (
    <div className="uv-central-container px-4 pt-5 my-5 text-center border-bottom">
      <h1 className="display-4 fw-bold">{props.title}</h1>
      <div className="col-lg-6 mx-auto">
        <div className="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
          <button onClick={throttledUpdateBaseData}
            className="btn btn-primary btn-lg px-4 me-sm-3">Update Base Data using Throtlling</button>
          <button onClick={debouncedUpdateBaseData}
            className="btn btn-primary btn-lg px-4">Update Base Data using Debouncing</button>
        </div>
      </div>
